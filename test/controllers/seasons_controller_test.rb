...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { year_end: @season.year_end, year_start: @season.year_start } }, as: :json
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { year_end: @season.year_end, year_start: @season.year_start } }, as: :json
    assert_response 200
  end
